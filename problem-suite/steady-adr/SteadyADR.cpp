...
SteadyADR<dim>::assemble()
{
    ...
    // Dirichlet boundary conditions.
    {
        ...
        if (dirichlet_conditions.empty() && fix_nullspace &&
            locally_owned_dofs.is_element(0))
...
template <unsigned int dim>
double
SteadyADR<dim>::compute_error(const VectorTools::NormType &norm_type,
