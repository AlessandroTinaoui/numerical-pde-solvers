...
public:
  ...
  double apply_interface_correction(DiffusionReactionDD &other, const double lambda, const double smoothing);

protected:
  std::map<types::global_dof_index, types::global_dof_index> compute_interface_map(const DiffusionReactionDD &other) const;
